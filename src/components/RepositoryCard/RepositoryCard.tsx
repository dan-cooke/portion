        ...
        <RepositoryCard>
            <CardHeader>
                <RepositoryTitle>
                    ...
                    <ThemedComponent elementName="a" innerProps={{href: `${githubUrl}/${repoOwner}`}}>{repoOwner}</ThemedComponent> /     
                    <ThemedComponent elementName="a" innerProps={{href:`${githubUrl}/${repoOwner}/${repoName}`}}>{repoName}</ThemedComponent>
                </RepositoryTitle>
            </CardHeader>
